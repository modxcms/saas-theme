    ...
    <div class="container">
        <div class="row pt-3">
            ...
            <div class="col-md-8 px-5 pt-lg-3 mt-5 mt-md-0">
                <h2 class="fw-light">Beacon Lead Magnet</h2>
                <p class="lead"> A great cta is persuasive, creates a sense of urgency, and is action oriented. </p>
                <form class="form-inline">
                    ...
                    <div class="col"><button type="submit" class="btn btn-primary text-white fw-light mb-sm-2">Download</button></div>
                </form>
            </div>
        </div>
    </div>
